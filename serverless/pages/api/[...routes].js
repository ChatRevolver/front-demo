...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ _routes_)
});

// EXTERNAL MODULE: ./node_modules/http-proxy-middleware/dist/index.js
var dist = __webpack_require__(2890);
;// CONCATENATED MODULE: ./src/@yoldi/utils/proxy-api.ts
...
const proxyApi = (url, context) => (0,dist/* createProxyMiddleware */.e)(_objectSpread({
  target: url,
  changeOrigin: true,
...
;// CONCATENATED MODULE: ./src/pages/api/[...routes].ts

/* harmony default export */ const _routes_ = (proxyApi("https://api.chatrevolver.com"));
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_api_handler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(88277);
      ...
      processEnv([])
        ...
        const apiHandler = (0,next_dist_build_webpack_loaders_next_serverless_loader_api_handler__WEBPACK_IMPORTED_MODULE_1__/* .getApiHandler */ .Y)({
          pageModule: __webpack_require__(17754),
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [2838,5895,1874], () => (__webpack_require__(13621)))
